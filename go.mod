...
require (
	github.com/blesswinsamuel/infra-base v0.0.0-20240626003147-bd266a705d6b
...
require (
	...
	github.com/external-secrets/external-secrets v0.9.17 // indirect
	...
	github.com/traefik/traefik/v3 v3.0.0 // indirect
